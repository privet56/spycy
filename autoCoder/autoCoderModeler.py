...
class AutoCoderModeler:
    ...
    def getModelPathName(self):
        ...
        return os.path.join(self.datadir,'{0}.kerasmodel'.format(self.prefix))
    ...
    def save(self):
        ...
        #self.model.save_weights(os.path.join(self.datadir,'{0}.kerasmodel.h5'.format(self.prefix)))
        #with open(os.path.join(self.datadir,'{0}.kerasmodel.json'.format(self.prefix), "w") as json_file:
    ...
    def generateCode(self, collector, count, prefix, stdout):
        for i in range(count):
            ...
            with open(os.path.join(self.datadir, prefix+".{0}.autoGeneratedCode".format(i)), 'w', ) as codefile:       # 'w' overwrites
